...
//testo aggiunto pre-form caricamento cv
  ...
  $lan['pre-form-upload-title'] = $tradController->getTraduzione('inserisci-cv-title-ita');
  ...
  $lan['pre-form-upload-text'] = $tradController->getTraduzione('inserisci-cv-text-1-ita');
  //testo post-form
  //$lan['post-form-link-cv'] = 'Qui il link per il DOWNLOAD del curriculum vitaee fomato europeo da compilare';
  $lan['post-form-link-cv'] = $tradController->getTraduzione('inserisci-cv-link-ita');
  ...
  $lan['post-form-text'] = '<p>'.$tradController->getTraduzione('inserisci-cv-text-2-ita').'</p>';
  //scopri cv 
  //$lan['find-cv-title'] = 'Benvenuto nella sezione "The WorkNote CV offrire lavoro"';
  $lan['find-cv-title'] = $tradController->getTraduzione('scopri-cv-title-ita');
  ...
  $lan['find-cv-text'] = $tradController->getTraduzione('scopri-cv-text-1-ita');
  //$lan['how-it-works-title'] = 'Come funziona:';
  $lan['how-it-works-title'] = $tradController->getTraduzione('scopri-cv-how-title-ita');
  ...
  $lan['how-it-works-text'] = $tradController->getTraduzione('scopri-cv-text-2-ita');
    //other messages
